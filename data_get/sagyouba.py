...
class control_th():
    ...
    def Myo_get(self):
        ...
        ser1 = serial.Serial("COM3",115200) #デバイス名とボーレート（arduino側も同じ数値に要設定）
        ...
        while not self.stop_event.is_set():
            ...
            if size_count % 10 == 0:
                ...
                if size_count % 100 == 0:
                    print "indent = ", indent, " time_duration = ", t_data3, " waiting_bytes = ", wait_size
                    size_count = 0
                elif wait_size >= 64:
                    print "waiting_bytes = ", wait_size
    ...
    def Data_Sample(self):
        ...
        pygame.midi.init()
        input_id = 1#pygame.midi.get_default_input_id() sd-50 = 2 octa-capture = 1
...
if __name__ == "__main__":
    filename_head = "..\\..\\data\\mainexperiment\\1\\" #record file path head
    print "file path = ", filename_head

    print "input num that \"file_num\", or press \"Q\" for exit"
    file_num = raw_input()
    ...
    MdPF_Frames1 = MdPF_calc(MyoRe_frames1, Midi_Frames)
    MdPF_Frames2 = MdPF_calc(MyoRe_frames2, Midi_Frames)
